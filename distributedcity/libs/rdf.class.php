<?php
/* $Id: rdf.class.php,v 1.1.1.1 2002/06/19 00:15:10 gente_libre Exp $ */
...
/**
* Class  RDF/RSS Parser
*
* This class offers methods to parse RDF/RSS Files
*
...
* @version   1.5 (2001-11-06) $Revision: 1.1.1.1 $
* @access    public
*/
...
class fase4_rdf {
    ...
    * @var    string
    */
    var $_cache_dir = "/websites/distributedcity.com/cache/";  // String
    ...
    */
    function fase4_rdf()
    {
        // default Value in seconds, to be overwritten in set_refresh()
        $this->_refresh = (time() - 60 * 60);
    }
